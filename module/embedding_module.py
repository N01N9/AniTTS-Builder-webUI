...
def compute_cosine_similarity_batch(device, embeddings, cosine_similarity, batch_size):
...
def embeddings(directory, all_embeddings_path, outputfile_path, batch_size):
    ...
    result_tensor = compute_cosine_similarity_batch(device, all_embeddings_tensor, cosine_similarity, batch_size=batch_size)
