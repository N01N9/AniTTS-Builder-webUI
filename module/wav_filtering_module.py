...
def find_and_filtering_files_based_on_json(json_path,source_dir,persent):
...
def spectrogram_json(input_folder, output_folder, output_json_path, source_dir, persent):
    ...
    find_and_filtering_files_based_on_json(output_json_path, source_dir, persent)